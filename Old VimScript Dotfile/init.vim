...
autocmd Filetype java nnoremap <buffer> <F5> :w<CR>:!javac -d . *.java<CR>
""autocmd Filetype java nnoremap <buffer> <F7> :w<CR>:!java %<CR>
""autocmd Filetype java nnoremap <buffer> <F7> :w<CR>:!java -cp  . *.class<CR>
autocmd Filetype java nnoremap <buffer> <F6> :w<CR>:!java %<CR>
